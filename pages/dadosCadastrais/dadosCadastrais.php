...
<body>
    ...
    <div class="content">
        ...
        <div class="right">
            ...
            <form class="row d-flex justify-content-center" id="form" method="GET" action="dadosCadastraisAction.php">

                <div class="row justify-content-center mb-5">
                    <div class="col-6 col-lg-4">
                        <input type="text" id="name" name="Nome completo" class="form-control" placeholder="Nome completo" onblur="validateInput(this)" required>
                        <div class="invalid-feedback" id="invalid-message-name">Informe um nome válido.<br> <em>Ex: Tyler Durden</em></div>
                    </div>
                    <div class="col-6 col-lg-4">
                        <input type="email" id="email" name="E-mail" class="form-control" placeholder="E-mail*" onblur="validateInput(this)" required>
                ...
                <div class="row justify-content-center mb-5">
                    ...
                    <div class="col-4 col-lg-2">
                        <input type="tel" maxLength="15" id="phone" name="Celular" class="form-control" placeholder="Celular*" onblur="validateInput(this)" required>
                        <div class="invalid-feedback" id="invalid-message-phone">Informe um celular válido.<br> <em>Ex: (11) 90000-0000</em></div>
                    </div>
                </div>

                <div class="row justify-content-center mb-5">
                    <div class="col-4 col-lg-3">
                        <input type="date" id="birthDate" name="Data de Nascimento" class="form-control" placeholder="Data de nascimento*" onblur="validateInput(this)" required>
                    ...
                    <div class="col-5 col-lg-3">
                        <select class="form-select" id="maritalStatus" name="Estado Civil" onchange="validateInput(this)" required>
                    ...
                    <div class="col-3 col-lg-2">
                        <select class="form-select" id="gender" name="Sexo*" onchange="validateInput(this)" required>
                ...
                <div class="row justify-content-center mb-5">
                    ...
                    <div class="col-4 col-lg-2">
                        <select class="form-select" id="state" name="Estado" onchange="validateInput(this)" required>
                ...
                <div class="row justify-content-center mb-5">
                <div class="col-4 col-lg-3">
                        <input type="text" id="houseNumber" name="Número de residência*" class="form-control" placeholder="Número da residência" onblur="validateInput(this)" required>
                    ...
                    <div class="col-4 col-lg-2">
                        <input type="tel" id="cep" name="CEP" maxLength="9" class="form-control" placeholder="CEP*" onblur="validateInput(this)" required>
