...
-- -----------------------------------------------------
-- Schema PICARETALEILOES
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema PICARETALEILOES
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `PICARETALEILOES` ;
USE `PICARETALEILOES` ;
...
CREATE TABLE IF NOT EXISTS `PICARETALEILOES`.`Marca` (
  ...
  UNIQUE INDEX (`marcaId` ASC, `descricao` ASC) VISIBLE);
...
CREATE TABLE IF NOT EXISTS `PICARETALEILOES`.`Modelo` (
  ...
  UNIQUE INDEX (`anoModelo` ASC, `modeloId` ASC) VISIBLE,
  INDEX `FK_Modelo_Marca` (`marcaId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `PICARETALEILOES`.`ModeloCor` (
  ...
  INDEX `FK_Modelo_ModeloCor` (`modeloId` ASC) VISIBLE,
  INDEX `FK_ModeloCor_Cor` (`corId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `PICARETALEILOES`.`Veiculo` (
  ...
  INDEX `fk_Veiculo_ModeloCor1_idx` (`modeloCorId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `PICARETALEILOES`.`Lote` (
  ...
  INDEX `FK_Lote_Leilao` (`leilaoId` ASC) VISIBLE,
  INDEX `FK_Lote_Financeira` (`financeiraId` ASC) VISIBLE,
  UNIQUE INDEX `loteId_UNIQUE` (`loteId` ASC) VISIBLE,
  INDEX `fk_Lote_Veiculo1_idx` (`veiculoId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `PICARETALEILOES`.`Lance` (
  ...
  UNIQUE INDEX (`sequencia` ASC, `lanceId` ASC) VISIBLE,
  INDEX `fk_Lance_Lote1_idx` (`loteId` ASC, `leilaoId` ASC) VISIBLE,
  INDEX `fk_Lance_Pessoa1_idx` (`loginId` ASC) VISIBLE,
  UNIQUE INDEX `lanceId_UNIQUE` (`lanceId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `PICARETALEILOES`.`Endereco` (
  ...
  `loginId` INT NOT NULL,
  PRIMARY KEY (`loginId`),
  INDEX `fk_Endereco_Pessoa1_idx` (`loginId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `PICARETALEILOES`.`ImagensLote` (
  ...
  `leilaoId` INT NOT NULL,
  UNIQUE INDEX (`tipoImagem` ASC) VISIBLE,
  PRIMARY KEY (`loteId`, `tipoImagem`, `leilaoId`),
  INDEX `fk_ImagensLote_Lote1_idx` (`leilaoId` ASC) VISIBLE,
